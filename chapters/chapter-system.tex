...
We preprocess the trainings samples with one step by subtracting the mean of all images from the dataset from each sample \citep{krizhevsky_imagenet_2012}. Through this step the input data becomes zero-centered.\\
