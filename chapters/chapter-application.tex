...
\figreft{fig:retrieval} displays some qualitative examples from those sets. Observe in the first how from the query portrait of Dante, three other portraits of Dante were retrieved (the second retrieval is from a different image depicting the same portrait).
