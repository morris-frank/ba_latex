...
\begin{figure}[htb]
    ...
    \begin{tabular}{ccccccc}
      \includegraphics[height=1.8cm]{figures/hm_examples/1sample_2008_002067} &
      \includegraphics[height=1.8cm]{figures/hm_examples/1sample_2009_004323} &
      \includegraphics[height=1.8cm]{figures/hm_examples/1sample_2009_004784} &
      \includegraphics[height=1.8cm]{figures/hm_examples/1sample_2009_005222} &
      \includegraphics[height=1.8cm]{figures/hm_examples/1sample_2009_002715} &
      \includegraphics[height=1.8cm]{figures/hm_examples/1sample_2010_005967} \\

      \includegraphics[height=1.8cm]{figures/hm_examples/50sample_2008_002067} &
      \includegraphics[height=1.8cm]{figures/hm_examples/50sample_2009_004323} &
      \includegraphics[height=1.8cm]{figures/hm_examples/50sample_2009_004784} &
      \includegraphics[height=1.8cm]{figures/hm_examples/50sample_2009_005222} &
      \includegraphics[height=1.8cm]{figures/hm_examples/50sample_2009_002715} &
      \includegraphics[height=1.8cm]{figures/hm_examples/50sample_2010_005967}
    \end{tabular}
...
\end{figure}
We test the pipeline for the class-parts combinations $(c,p)$ listed in appendix \ref{sec:appendix:combos} using the cascade scheme described  in \treft{sec:results:repeat}.
